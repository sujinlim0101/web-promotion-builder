...
import { createPromoPage } from "../graphql/mutations";
export default function PromoPageCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createPromoPage.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PromoPageCreateForm")}
      {...rest}
    >
      <TextAreaField
        label="Info"
